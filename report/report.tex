...
\label{fun:fetch}
\verbatiminput{../matlab/fetch.m}
\subsection{\texttt{filterecg()}}
\label{fun:filter}
\verbatiminput{../matlab/filterecg.m}
\subsection{\texttt{findqrs()}}
\label{fun:qrs}
\verbatiminput{../matlab/findqrs.m}
\subsection{\texttt{crop()}}
\label{fun:crop}
\verbatiminput{../matlab/crop.m}
\subsection{\texttt{pca\_transform()}}
\label{fun:pca}
\verbatiminput{../matlab/pca_transform.m}
\subsection{\texttt{plotpca()}}
\label{fun:plotpca}
\verbatiminput{../matlab/plotpca.m}
\subsection{\texttt{plotecg()}}
\label{fun:plotecg}
\verbatiminput{../matlab/plotecg.m}
\subsection{\texttt{texify()}}
\label{fun:tex}
\verbatiminput{../matlab/texify.m}
\subsection{\texttt{gather.m}}
\label{scr:gather}
\verbatiminput{../matlab/gather.m}
\subsection{\texttt{figures.m}}
\label{scr:figures}
\verbatiminput{../matlab/figures.m}
\subsection{\texttt{train.m}}
\label{scr:train}
\verbatiminput{../matlab/train.m}
