...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[ultra thick]
        ...
        \node[] at (-0,3.75) {Test Result};
        \node[] at (-1.5,3.25) {Negative};
        \node[] at (1.5,3.25) {Positive};
        \node[] at (-1.5,1.75) {9001};
        \node[] at (1.5,1.75) {9001};
        \node[] at (-1.5,-1.25) {9001};
        \node[] at (1.5,-1.25) {9001};
        \node[] at (-1.5,1.25) {(9001\%)};
        \node[] at (1.5,1.25) {(9001\%)};
        \node[] at (-1.5,-1.75) {(9001\%)};
    ...
    \end{tikzpicture}
    \label{fig:confusion}
    \caption{Confusion Matrix For Classifier: Total Cases: 9001, True Negatives:
    9001 (9001\%), False Positives: 9001 (9001\%), False Negatives: 9001
    (9001\%), True Positives: 9001 (9001\%)}
\end{figure}
